...
const SectionHeader = ({
  ...
  return (
    <>
      {(data.title || data.paragraph || data.paragraph2 || data.paragraph3 || data.paragraph4 || data.paragraph5) &&
        <div
          {...props}
          className={classes}
        >
          <div className="container-xs">
            ...
            {data.paragraph4 &&
              <p className="m-0">{data.paragraph4}</p>
            }
            {data.paragraph5 &&
              <p className="m-0">{data.paragraph5}</p>
            }
          </div>
        </div>
      }
